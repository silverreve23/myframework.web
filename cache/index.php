		...
		<!-- Banner -->
			...
			<section id="two" class="wrapper style2 alt">
				<div class="inner">
					...
					<div class="spotlight">
						<div class="image">
							<img src="/templates/images/pic01.jpg" alt="" />
						</div>
						<div class="content">
...
Lorem ipsum nisl sed cursus magna et amet veroeros. Sed phasellus malesuada quis orci....</p>

							<ul class="actions">
								<li><a href="/view/1" class="button alt">Details</a></li>
							</ul>
						</div>
					</div>
					...
					<div class="spotlight">
						<div class="image">
							<img src="/templates/images/pic02.jpg" alt="" />
						</div>
						<div class="content">
							...
							<ul class="actions">
								<li><a href="/view/2" class="button alt">Details</a></li>
							</ul>
						</div>
					</div>
